...
def parse_args():
    ...
    ##################################### Dataset #################################################
    parser.add_argument(
        "--data", type=str, default="datasets", help="location of the data corpus"
    )
    ...
    parser.add_argument("--workers", type=int, default=12, help="number of workers in dataloader")
    ...
    parser.add_argument("--epochs", default=50, type=int, help="number of total epochs to run")  # default=182)
    ...
    # if IU: control the magnitude of the adjustment made to the model's parameters, higher alpha means stronger adjustment
    ...
    ################## SAM setting ###################
    parser.add_argument("--sam", default=None, type=str, choices=['min', 'max'], help="whether using sam")
    parser.add_argument("--separate", nargs=2, default=None, help="separate optimizers for NegGrad")
    parser.add_argument("--adaptive", action="store_true", help="Enable Adaptive SAM")
    parser.add_argument("--rho", default=0.1, type=float, help="Rho for SAM.")
    parser.add_argument("--lamb", default=1, type=float, help="Lambda for SAM max, should be 1 for min.")
    parser.add_argument("--xi", default=0., type=float, help="Xi for regularizing SAM max.")
    parser.add_argument("--es",  action="store_true", help="Compute ES with model and retain/forget")
    parser.add_argument("--novisual",  action="store_true", help="Enable visualization when ES")
    ...
    parser.add_argument("--mem", default=None, type=int, help="memorization (high or low)")
