...
def wide_resnet14_2(pretrained=False, progress=True, **kwargs):
    kwargs["width_per_group"] = 64 * 2
    assert pretrained == False # not standard arch, train from scratch
    return _resnet(
        "wide_resnet14_2", Bottleneck, [1, 1, 1, 1], pretrained, progress, **kwargs
    )
