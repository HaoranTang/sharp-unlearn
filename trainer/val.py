...
def wandb_init(args):
    ...
    if args.wandb_run_id is not None:
        ...
        if args.sam:
            run_name = f"{args.dataset}_{args.arch}_pretrain_sam-{args.sam}_rho{args.rho}_lambda{args.lamb}_xi{args.xi}_lr{args.lr}_epoch{args.epochs}"
        else:
